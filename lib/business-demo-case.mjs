// Authored business-school tutorial; no real company, employee or publication.
...
export const businessCase = {
  ...
  overview:
    'Alex is asked to show that a training program pays for itself. Follow how the researcher separates revenue from profit, examines training selection, defines a defensible comparison, handles incomplete records and reports an uncertain result without turning it into an ROI claim.',
  ...
  stages: [
    {
      id: 'question',
      title: 'Turn a business request into a research question',
      ...
      turns: [
        ...
        [
          ...
          'Revenue is not profit. Do you have costs, contribution margins, a baseline, or random assignment to training?',
        ],
        [
          'Alex · researcher',
          'No. Managers selected participation and employees chose how many hours to attend. I only have training hours and next-month booked sales revenue, in thousands of US dollars.',
        ],
        [
          'Methods mentor · simulated agent',
          'Then ask about the unadjusted association between training hours and next-month revenue in this sample. Profit, training ROI and causal effects are outside what these data can establish.',
        ],
        [
          'Alex · researcher',
          'I accept this question: Among the 14 fictional full-time sales representatives at Northstar, how are training hours in April associated with booked sales revenue in May? A weak or uncertain association is a legitimate answer.',
        ],
      ],
      artifact:
        'Question: Among 14 fictional full-time Northstar sales representatives, how are April training hours associated with May booked sales revenue?\nUnit: One representative, one training month and one subsequent sales month.\nExposure: Recorded training hours in April.\nOutcome: May booked sales revenue in thousands of US dollars (kUSD), not profit, margin or cash collected.\nData: Entirely synthetic teaching records; no real firm or employees.\nEstimand: Unadjusted linear association in this sample.\nBoundary: No causal training effect, profitability claim or generalization to other businesses.',
      understanding:
        'A manager’s decision question can be broader than the research question the data can answer. Renaming revenue as performance or profit would hide that mismatch.',
      review:
        'Professor Patel · fictional supervisor: Accept the restricted association question. Retain the original managerial request as motivation, not as a claim the analysis will resolve.',
      carry:
        'The definitions of revenue, timing and observational unit constrain the source search, protocol, regression units and business implications.',
      challenge: {
    ...
    {
      id: 'evidence',
      title: 'Separate a plausible mechanism from evidence',
      where: 'Sources → Claims & evidence → Your workspace',
      input:
        'The accepted question concerns training hours and later sales revenue. Alex considers skill development as a possible mechanism and manager selection as a competing explanation.',
      turns: [
        [
          'Alex · researcher',
      ...
      understanding:
        'Theory helps me specify mechanisms and rival explanations. It cannot convert an observational comparison into causal evidence.',
      review:
        'Fictional supervisor: Preserve the selection explanation in the protocol. Real scholarship requires authentic sources, critical synthesis and a defensible contribution.',
      carry:
        'Baseline ability, territory opportunity and selection become explicit omitted variables, preventing a later claim that the regression controls for them.',
    },
    {
      id: 'design',
      title: 'Define the unit, timing and analysis',
      where: 'Guided conversation → Your workspace → Supervisor review',
      input:
    ...
    {
      id: 'data',
      title: 'Audit the business measures',
      where: 'Run analysis → Import a permitted CSV dataset → Your workspace',
      input:
        'The protocol requires training hours and subsequent revenue in kUSD, one row per representative.',
      turns: [
        [
          'Alex · researcher',
    ...
    {
      id: 'interpretation',
      title: 'Keep the executive claim within the evidence',
    ...
    {
      id: 'writing',
      title: 'Write the academic report and executive summary',
      where:
        'Your workspace → Supervisor review → Export project → Readable report or project backup; Run analysis → Download reproduction bundle',
      input:
        'The research package combines the question, mechanism and rival explanation, protocol, audit, actual R results and corrected business claim.',
      turns: [
        [
          'Alex · researcher',
