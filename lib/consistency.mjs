...
const core = ['question', 'design', 'analysis', 'interpretation'];
export function consistencySnapshot(project) {
  return consistencyStageIds.map((id) => {
...
export function consistencyIsCurrent(project, report) {
  return report.snapshot.every((s) => {
